...
```
aws ecr get-login-password --region eu-central-1 --profile [PROFILE] | docker login --username AWS --password-stdin 533267435179.dkr.ecr.eu-central-1.amazonaws.com
```
...
```
docker tag backend-loadtest:latest 533267435179.dkr.ecr.eu-central-1.amazonaws.com/backend-loadtest:latest
```

```
docker push 533267435179.dkr.ecr.eu-central-1.amazonaws.com/backend-loadtest:latest
```
